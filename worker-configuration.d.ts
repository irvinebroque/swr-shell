/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: 0f7580161d4aaec69731445595bcc3c3)
...
declare namespace Cloudflare {
	...
	interface Env {
		ASSETS: Fetcher;
		BOOTSTRAP_ORIGIN_URL: "https://bootstrap-data-r2-eu.apreswhatever.com/api/bootstrap";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOOTSTRAP_ORIGIN_URL">> {}
}
